  ...
  builder: (context, state) {
    ...
    child: ButtonsTableWidget(),
          ...
          if(meetingsCubit.selectedTap == 0)
            MeetingsDetailsWidget(meetingsBodyModel:meetingsCubit.meetingsBodyModel,meetingId:widget.meetingId,),
          if(meetingsCubit.selectedTap==1)
            MeetingsAttendanceWidget(meetingsAttendanceModel:meetingsCubit.meetingsAttendanceModel,meetingId:widget.meetingId,),
          if(meetingsCubit.selectedTap==2)
            MeetingsRecommendationsWidget()
    ]));
  },
));
  }
